  ...
  data: function data() {
    return {
      product: [{
        ...
        name: "lorem",
        avg_rating: 2,
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT0o5Y9SQQWrmzd0s7euMYFmgtmxYOBE6Srb7JqcPAHYBzFfDZS&usqp=CAU",
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "div",
      { staticClass: "row" },
      _vm._l(_vm.product, function(products, i) {
        return _c(
          "div",
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "card" }, [
                  _c("img", {
                    attrs: { src: products.img, alt: "Denim Jeans" }
                  }),
                  _vm._v(" "),
                  _c("h1", [_vm._v(_vm._s(products.name))]),
                  _vm._v(" "),
